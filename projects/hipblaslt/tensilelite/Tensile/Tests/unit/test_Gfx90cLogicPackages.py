...
EXPECTED = {
    "vega10_Cijk_Ailk_Bljk_HB.yaml": ((85, 853), (80, 851)),
    "vega10_Cijk_Ailk_Bljk_HHS_BH.yaml": ((109, 1540), (67, 842)),
...
def test_lite_mac_vector_widths_are_current_and_codegen_compatible():
    for path in LITE_ROOT.glob("*.yaml"):
        ...
        for solution in logic[5]:
            ...
            assert solution["GlobalLoadVectorWidthA"] in (
                1,
                solution["VectorWidthA"],
            )
            assert solution["GlobalLoadVectorWidthB"] in (
                1,
