...
def _load_layernorm_mod():
    p = Path(__file__).resolve().parents[3] / "LayerNormGenerator.py"
    spec = importlib.util.spec_from_file_location("LayerNormGenerator_under_test", p)
